...
`sandbox.build` stripped — your source `spec.yaml` is never modified), and builds
...
consumption — mutable references are a security no-go. Resolve the digest and hand
that out:
